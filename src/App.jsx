    ...
    const lng = coordinates.lng.toFixed(5)
     ...
     fetch(`https://api.openweathermap.org/data/3.0/onecall?lat=${lat}&lon=${lng}&exclude=alerts,minutely&days=7&units=metric&appid=${apiKey}`)
      ...
      .then(data => {
        ...
        setLocationInfo({location: locationName,
  ...
  return (
    <div className="background-blur">
      <div className="app-container">
        ...
        : <ChooseCity coordinates={coordinates} setCoordinates ={setCoordinates} setLocationChosen={setLocationChosen} locationChosen={locationChosen}/> }
      </div>
   </div>
  ) 
}